...
// Informasi Tanggal = new Date(Tahun, Bulan 0 - 11, Tanggal, Jam, Menit, Detik);
const FLASH_SALE_END = new Date(2026, 1, 25, 23, 59, 59); // Ubah tanggal jika perlu
let cart = [];
